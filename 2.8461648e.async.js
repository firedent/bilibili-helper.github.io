...
`;class B extends n.default.Component{constructor(e){var t;super(e),t=this,this.load=(()=>{var e=this.props,t=e.comments,a=e.dispatch,o=e.location,r=t.config,i=o.query,n=i.oid,l=void 0===n?r.oid:n,s=i.page,c=void 0===s?1:s,d=i.ptype,p=void 0===d?0:d,u=i.type,g={oid:l,[+p?"ps":"pn"]:c,type:u};a({type:"comments/load",payload:{query:g,ptype:+p}})}),this.calculateNavigationPageIndex=((e,t)=>{var a=new Array(t).fill(void 0).map((e,t)=>t),o=i.default.compact(a.map((t,a)=>{if(Math.abs(e-a-1)<=2)return a+1<=0?void 0:a+1}));return 1!==o[0]&&(o[0]>2&&o.unshift("-"),o.unshift(1)),o.length>1&&o[o.length-1]<t&&(t-o[o.length-1]>1&&o.push("-"),o.push(t)),o}),this.handleOnClickHots=(()=>{this.props.dispatch({type:"comments/fetchComment",payload:{sort:1}})}),this.handleOnClickLoadMoreReplies=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};t.props.dispatch({type:"comments/fetchReply",payload:(0,r.default)({pn:1,ps:10},e)})},this.handleOnClickNavigation=(()=>{window.scrollTo(0,(0,b.cumulativeOffset)(this.moreCommentListWrapper).top-20)}),this.handleOnClickNavigationForReply=(e=>{var t=this[`reply-${e.root}`];t&&t.querySelector(".replies-box").scrollIntoView({behavior:"smooth",inline:"start"}),this.props.dispatch({type:"comments/fetchReply",payload:e})}),this.handleOnClickReply=(e=>{var t=e.uname,a=e.rpid;return this.setState({uname:t,rpid:a===this.state.rpid?null:a})}),this.handleOnClickLike=((e,t)=>{this.props.dispatch({type:"comments/setLike",payload:{action:e,rpid:t}})}),this.handleOnClickHate=((e,t)=>{this.props.dispatch({type:"comments/setHate",payload:{action:e,rpid:t}})}),this.renderContent=(e=>{var t=new RegExp(/(\[.*?\])/g),a=[],o=null,r=0;while(null!==(o=t.exec(e))){var i=o,l=i.index,s=o[0];a.push(e.substr(r,l-r)),r=l+s.length,a.push(n.default.createElement(g.default,{key:l,sign:s}))}return 0===a.length&&a.push(e),a}),this.renderLine=(e=>{var t=e.rpid,a=e.top,o=this.props.comments,r=o.config,i=o.status,l=this.props.comments.replyMap[t],s=l.self,c=s.action,p=s.content,g=s.member,h=s.floor,b=s.ctime,f=s.like,x=s.oid,E=s.root,B=this.state,k=B.uname,C=B.rpid,Q=g.avatar,D=g.mid,y=g.uname,j=g.level_info,I=g.vip,M=j.current_level,N=I.vipType,O=C===t,G=[],F=!1;return l.replies&&(F=l.needExpand&&!l.hasExpand,G=this.calculateNavigationPageIndex(l.page.num,l.pages)),n.default.createElement(v,{key:t,id:t,ref:e=>this[`reply-${t}`]=e},n.default.createElement("div",{className:"user"},n.default.createElement(u.default,{className:"avatar",url:Q,sign:D})),n.default.createElement("div",{className:"main"},n.default.createElement("div",{className:"header"},a&&n.default.createElement("span",{className:"top"},"TOP"),n.default.createElement("a",{className:`username ${N?"vip":""}`,href:`https://space.bilibili.com/${D}`,target:"_blank"},y),M&&n.default.createElement("span",{className:"level"},"Lv.",M),n.default.createElement("span",{className:"moment"},(0,d.default)(1e3*b).startOf("second").fromNow()),h&&n.default.createElement("span",{className:"floor"},"#",h)),n.default.createElement("div",{className:"content"},n.default.createElement("pre",null,this.renderContent(p.message)),n.default.createElement("div",{className:"toolbar"},n.default.createElement("div",{className:"like-box"},n.default.createElement("span",{className:"like",on:1===c?"1":"0",onClick:()=>this.handleOnClickLike(Number(1!==c),t)},"LIKE ",f||""),n.default.createElement("span",{className:"hate",on:2===c?"1":"0",onClick:()=>this.handleOnClickHate(Number(2!==c),t)},"HATE")),n.default.createElement("button",{className:"reply",on:O?"1":"0",onClick:()=>this.handleOnClickReply({uname:y,rpid:t})},"REPLY"))),O&&n.default.createElement(A.default,{root:E||t,parent:t,name:k}),l.replies&&l.replies.length>0&&n.default.createElement("div",{className:"replies-box"},n.default.createElement("div",{className:"replies"},l.replies.map(e=>this.renderLine(e))),F&&1===l.page.num&&n.default.createElement(w,{onClick:()=>this.handleOnClickLoadMoreReplies({root:t,oid:x})},"~ LOAD MORE ~"),!F&&l.pages>1&&this.renderPageNavigation({oid:r.oid,pageIndex:G,num:l.page.num,pages:l.pages,root:t,ptype:1}),i.comment.loadingRpid===t&&n.default.createElement("div",{className:"loading-page-mask"},n.default.createElement(u.default,{url:m.LOADING_IMAGE_URL,sign:"loading-gif"})))))}),this.renderPageNavigation=(e=>{var t=e.oid,a=e.pageIndex,o=e.num,r=e.pages,i=e.root,l=e.ptype,s=void 0===l?0:l,d=()=>{};return d=i?e=>this.handleOnClickNavigationForReply({pn:e,ps:10,sort:0,root:i}):e=>this.handleOnClickNavigation({pn:e}),n.default.createElement(E,null,a.length>2&&o>1&&n.default.createElement(c.default,{key:"prev",to:`?oid=${t}&page=${o-1}&ptype=${s}`},n.default.createElement("span",{className:"page-navigation-link",onClick:()=>d(o-1)},"PREV")),a.map((e,a)=>{return n.default.createElement(c.default,{key:e+a,to:`?oid=${t}&page=${e}&ptype=${s}`},n.default.createElement("span",{className:`page-navigation-link ${"-"===e?"omit":""} ${o===e?"now":""}`,onClick:o!==e&&"-"!==e?()=>d(e):null},"-"!==e?e:"..."))}),a.length>2&&o<r&&n.default.createElement(c.default,{key:"next",to:`?oid=${t}&page=${o+1}&ptype=${s}`},n.default.createElement("span",{className:"page-navigation-link",onClick:()=>d(o+1)},"NEXT")))}),this.render=(()=>{var e=this.props,t=e.comments,a=e.user,o=e.global,i=this.state,l=i.mid,s=i.uname,c=t.data,d=t.config,p=t.status,g=c.page,b=c.hots,v=c.top,E=c.replies,B=void 0===E?[]:E,k=g.count,C=g.size,Q=g.acount,D=g.num,y=Math.ceil(k/C)||1,j=this.calculateNavigationPageIndex(D,y);return n.default.createElement(h.default,null,n.default.createElement(f,null,n.default.createElement(x,null,`${Q} \u8bc4\u8bba`,n.default.createElement("p",null,"\u672c\u8bc4\u8bba\u533a\u6765\u81ea\u54d4\u54e9\u54d4\u54e9\u5f39\u5e55\u7f51\u7684\u8bc4\u8bba\u7cfb\u7edf\uff0c\u539f\u5730\u5740\u4e3a:",n.default.createElement("a",{target:"_blank",href:"https://h.bilibili.com/16116344#canvas-detail-comment-ctnr"},"h16116344"),"\uff0c\u5982\u679c\u65e0\u6cd5\u94fe\u63a5\u52a9\u624b\uff0c\u53ef\u4ee5\u524d\u5f80\u8be5\u9875\u9762\u8fdb\u884c\u7559\u8a00",n.default.createElement("br",null),"\u8bf7\u9075\u5b88\u76f8\u5173\u6cd5\u5f8b\u6cd5\u89c4\u5e76\u5171\u540c\u7ef4\u62a4\u79e9\u5e8f")),n.default.createElement(A.default,{global:!0,receiver:{mid:l,uname:s}}),o.status.connected&&n.default.createElement(n.default.Fragment,null,0===Q&&!v&&!b&&!B&&!p.comment.loadPage&&n.default.createElement("div",{className:"no-reply"},"\u6ca1\u6709\u7559\u8a00\uff0c",!a.info&&"\u767b\u9646\u540e","\u5f00\u59cb\u8bc4\u8bba\u5427~"),0!==Q&&(v||b||B||p.comment.loadPage)&&n.default.createElement("div",{className:"more-comment-list-wrapper",ref:e=>this.moreCommentListWrapper=e},1===D&&v&&n.default.createElement("div",{className:"wrapper"},n.default.createElement("div",{id:"top",className:"comment-list"},this.renderLine((0,r.default)({},v,{top:!0}))),n.default.createElement(w,{disabled:!0},"IT'S A TOP COMMENT ABOVE")),1===D&&b&&n.default.createElement("div",{className:"list-wrapper"},n.default.createElement("div",{id:"hots",className:"comment-list"},b.map(e=>v?e.rpid!==v.rpid&&this.renderLine(e):this.renderLine(e))),n.default.createElement(w,{onClick:this.handleOnClickHots},"LOAD MORE HOT COMMENTS")),B&&n.default.createElement("div",{className:"list-wrapper"},n.default.createElement("div",{id:"comments",className:"comment-list"},B.map(e=>v?e.rpid!==v.rpid&&this.renderLine(e):this.renderLine(e))),this.renderPageNavigation({oid:d.oid,pageIndex:j,num:D,pages:y})),p.comment.loadPage&&n.default.createElement("div",{className:"loading-page-mask"},n.default.createElement(u.default,{url:m.LOADING_IMAGE_URL,sign:"loading-gif"}))))))}),this.state={uname:"",rpid:null}}componentDidMount(){this.load()}componentDidUpdate(e){this.props.location.query.page!==e.location.query.page&&"0"===e.location.query.ptype&&this.load()}}var k=(0,s.default)((0,p.connect)(e=>{var t=e.global,a=e.comments,o=e.user;return{global:t,comments:a,user:o}})(B));t.default=k},HjWF:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("cDcd")),i=o(a("vOnD")),n=i.default.div`
  width: 800px;
  height: 20px;
  margin: 20px auto;
  & > * {
...
`;class m extends n.default.Component{constructor(e){super(e),this.renderLine=(e=>{var t=e.index,a=e.style,o=this.props.global,i=(0,r.default)(o.feeds[t],4),l=i[0],s=i[1],c=i[2],d=i[3],p=c>=10,u=c>=5&&c<10;return n.default.createElement(A,{style:a,key:t,className:`${u?"largeThanFive":p?"largeThanTen":""}`},n.default.createElement("span",{className:"date"},l),n.default.createElement("span",{className:"name"},s),n.default.createElement("span",{className:"num"},"\uffe5 ",Number(c).toFixed(2)),n.default.createElement("span",{className:"message"},d))})}render(){var e=this.props.global;return n.default.createElement(u,null,n.default.createElement(c.Header,null,"\u6295\u5582\u533a\u9e2d ~ FEEDS",n.default.createElement("p",null,"\u611f\u8c22\u5927\u5bb6\u7684\u652f\u6301\u9e2d~mua~")),n.default.createElement(g,{width:800,height:200,rowCount:e.feeds&&e.feeds.length||0,rowHeight:28,rowRenderer:this.renderLine,noRowsRenderer:()=>n.default.createElement("div",null,"\u65e0\u6570\u636e")}),n.default.createElement(i.default,{src:"../static/images/alipay-df.png"}))}}var h=(0,l.connect)(e=>{var t=e.global;return{global:t}})(m);t.default=h},rB1f:function(e,t,a){"use strict";var o=a("g2Oz"),r=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var i=r(a("cDcd")),n=a("MuoO"),l=o(a("vOnD")),s=r(a("Bo8p")),c=a("Kvkj"),d=l.createGlobalStyle`
  html {
...
`,p=()=>i.default.createElement(i.default.Fragment,null,i.default.createElement(d,null),i.default.createElement(c.HeaderArea,null),i.default.createElement(c.DownloadArea,null),i.default.createElement(c.VoteArea,null),i.default.createElement(c.AnnouncementArea,null),i.default.createElement(c.FeedbackArea,null),i.default.createElement(c.FeedArea,null),i.default.createElement(c.BadgeArea,null),i.default.createElement(c.CommentArea,null)),u=(0,s.default)((0,n.connect)(e=>e)(p));t.default=u},rY4l:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.Header=void 0;var r=o(a("cDcd")),i=o(a("vOnD")),n=i.default.h3`
  align-items: center;
  margin: 15px 0 20px;
  font-size: 16px;
  color: #212121;
