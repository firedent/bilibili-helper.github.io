...
`;class d extends r.default.Component{constructor(e){super(e),this.state={url:e.emoji.emojiURLs[e.sign]}}render(){var e=this.props.sign;return r.default.createElement(s,null,r.default.createElement(n.default,{url:this.state.url,sign:e}))}}var c=(0,i.connect)(e=>{var t=e.emoji;return{emoji:t}})(d);t.default=c},"0q1Z":function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("cDcd")),i=a("MuoO"),l=o(a("vOnD")),n=a("rY4l"),s=o(a("RXmK")),d=l.default.div`
  ol {
    //height: 180px;
...
`;class c extends r.default.Component{constructor(e){super(e)}render(){var e=this.props.global;return r.default.createElement(s.default,null,r.default.createElement(d,{id:"downloadArea"},r.default.createElement(n.Header,null,"\u7f51\u7ad9\u52a8\u6001 ~ DYNAMIC FOR WEBSITE",r.default.createElement("p",{className:"sub-title"},"\u8fd9\u91cc\u4f1a\u4e0d\u5b9a\u671f\u5217\u51fa\u7f51\u7ad9\u7684\u66f4\u65b0\u52a8\u6001~")),r.default.createElement("ol",{className:"tab-contents"},e.websiteUpdate&&e.websiteUpdate.map((e,t)=>r.default.createElement("div",{className:"info-item",key:t},r.default.createElement("li",{dangerouslySetInnerHTML:{__html:e}}))))))}}var p=(0,i.connect)(e=>{var t=e.global;return{global:t}})(c);t.default=p},"1ZZj":function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("cDcd")),i=a("MuoO"),l=o(a("vOnD")),n=a("rY4l"),s=o(a("RXmK")),d=l.default.div`
  ol {
    //height: 180px;
    //border: 10px solid var(--border-color);
    padding: 10px;
...
`;class B extends l.default.Component{constructor(e){var t;super(e),t=this,this.load=(()=>{var e=this.props,t=e.comments,a=e.dispatch,o=e.location,r=t.config,i=o.query,l=i.oid,n=void 0===l?r.oid:l,s=i.page,d=void 0===s?1:s,c=i.ptype,p=void 0===c?0:c,u=i.type,g={oid:n,[+p?"ps":"pn"]:d,type:u};a({type:"comments/load",payload:{query:g,ptype:+p}})}),this.calculateNavigationPageIndex=((e,t)=>{var a=new Array(t).fill(void 0).map((e,t)=>t),o=i.default.compact(a.map((t,a)=>{if(Math.abs(e-a-1)<=2)return a+1<=0?void 0:a+1}));return 1!==o[0]&&(o[0]>2&&o.unshift("-"),o.unshift(1)),o.length>1&&o[o.length-1]<t&&(t-o[o.length-1]>1&&o.push("-"),o.push(t)),o}),this.handleOnClickHots=(()=>{this.props.dispatch({type:"comments/fetchComment",payload:{sort:1}})}),this.handleOnClickLoadMoreReplies=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};t.props.dispatch({type:"comments/fetchReply",payload:(0,r.default)({pn:1,ps:10},e)})},this.handleOnClickNavigation=(()=>{window.scrollTo(0,(0,h.cumulativeOffset)(this.moreCommentListWrapper).top-20)}),this.handleOnClickNavigationForReply=(e=>{var t=this[`reply-${e.root}`];t&&t.querySelector(".replies-box").scrollIntoView({behavior:"smooth",inline:"start"}),this.props.dispatch({type:"comments/fetchReply",payload:e})}),this.handleOnClickReply=(e=>{var t=e.uname,a=e.rpid;return this.setState({uname:t,rpid:a===this.state.rpid?null:a})}),this.handleOnClickLike=((e,t)=>{this.props.dispatch({type:"comments/setLike",payload:{action:e,rpid:t}})}),this.handleOnClickHate=((e,t)=>{this.props.dispatch({type:"comments/setHate",payload:{action:e,rpid:t}})}),this.renderContent=(e=>{var t=new RegExp(/(\[.*?\])/g),a=[],o=null,r=0;while(null!==(o=t.exec(e))){var i=o,n=i.index,s=o[0];a.push(e.substr(r,n-r)),r=n+s.length,a.push(l.default.createElement(g.default,{key:n,sign:s}))}return 0===a.length&&a.push(e),a}),this.renderLine=(e=>{var t=e.rpid,a=e.top,o=this.props.comments,r=o.config,i=o.status,n=this.props.comments.replyMap[t],s=n.self,d=s.action,p=s.content,g=s.member,b=s.floor,h=s.ctime,f=s.like,x=s.oid,E=s.root,B=this.state,k=B.uname,C=B.rpid,Q=g.avatar,D=g.mid,y=g.uname,j=g.level_info,I=g.vip,M=j.current_level,N=I.vipType,O=C===t,G=[],F=!1;return n.replies&&(F=n.needExpand&&!n.hasExpand,G=this.calculateNavigationPageIndex(n.page.num,n.pages)),l.default.createElement(v,{key:t,id:t,ref:e=>this[`reply-${t}`]=e},l.default.createElement("div",{className:"user"},l.default.createElement(u.default,{className:"avatar",url:Q,sign:D})),l.default.createElement("div",{className:"main"},l.default.createElement("div",{className:"header"},a&&l.default.createElement("span",{className:"top"},"TOP"),l.default.createElement("a",{className:`username ${N?"vip":""}`,href:`https://space.bilibili.com/${D}`,target:"_blank"},y),M&&l.default.createElement("span",{className:"level"},"Lv.",M),l.default.createElement("span",{className:"moment"},(0,c.default)(1e3*h).startOf("second").fromNow()),b&&l.default.createElement("span",{className:"floor"},"#",b)),l.default.createElement("div",{className:"content"},l.default.createElement("pre",null,this.renderContent(p.message)),l.default.createElement("div",{className:"toolbar"},l.default.createElement("div",{className:"like-box"},l.default.createElement("span",{className:"like",on:1===d?"1":"0",onClick:()=>this.handleOnClickLike(Number(1!==d),t)},"LIKE ",f||""),l.default.createElement("span",{className:"hate",on:2===d?"1":"0",onClick:()=>this.handleOnClickHate(Number(2!==d),t)},"HATE")),l.default.createElement("button",{className:"reply",on:O?"1":"0",onClick:()=>this.handleOnClickReply({uname:y,rpid:t})},"REPLY"))),O&&l.default.createElement(A.default,{root:E||t,parent:t,name:k}),n.replies&&n.replies.length>0&&l.default.createElement("div",{className:"replies-box"},l.default.createElement("div",{className:"replies"},n.replies.map(e=>this.renderLine(e))),F&&1===n.page.num&&l.default.createElement(w,{onClick:()=>this.handleOnClickLoadMoreReplies({root:t,oid:x})},"~ LOAD MORE ~"),!F&&n.pages>1&&this.renderPageNavigation({oid:r.oid,pageIndex:G,num:n.page.num,pages:n.pages,root:t,ptype:1}),i.comment.loadingRpid===t&&l.default.createElement("div",{className:"loading-page-mask"},l.default.createElement(u.default,{url:m.LOADING_IMAGE_URL,sign:"loading-gif"})))))}),this.renderPageNavigation=(e=>{var t=e.oid,a=e.pageIndex,o=e.num,r=e.pages,i=e.root,n=e.ptype,s=void 0===n?0:n,c=()=>{};return c=i?e=>this.handleOnClickNavigationForReply({pn:e,ps:10,sort:0,root:i}):e=>this.handleOnClickNavigation({pn:e}),l.default.createElement(E,null,a.length>2&&o>1&&l.default.createElement(d.default,{key:"prev",to:`?oid=${t}&page=${o-1}&ptype=${s}`},l.default.createElement("span",{className:"page-navigation-link",onClick:()=>c(o-1)},"PREV")),a.map((e,a)=>{return l.default.createElement(d.default,{key:e+a,to:`?oid=${t}&page=${e}&ptype=${s}`},l.default.createElement("span",{className:`page-navigation-link ${"-"===e?"omit":""} ${o===e?"now":""}`,onClick:o!==e&&"-"!==e?()=>c(e):null},"-"!==e?e:"..."))}),a.length>2&&o<r&&l.default.createElement(d.default,{key:"next",to:`?oid=${t}&page=${o+1}&ptype=${s}`},l.default.createElement("span",{className:"page-navigation-link",onClick:()=>c(o+1)},"NEXT")))}),this.render=(()=>{var e=this.props,t=e.comments,a=e.user,o=e.global,i=this.state,n=i.mid,s=i.uname,d=t.data,c=t.config,p=t.status,g=d.page,h=d.hots,v=d.top,E=d.replies,B=void 0===E?[]:E,k=g.count,C=g.size,Q=g.acount,D=g.num,y=Math.ceil(k/C)||1,j=this.calculateNavigationPageIndex(D,y);return l.default.createElement(b.default,null,l.default.createElement(f,null,l.default.createElement(x,null,`${Q} \u8bc4\u8bba`,l.default.createElement("p",null,"\u672c\u8bc4\u8bba\u533a\u6765\u81ea\u54d4\u54e9\u54d4\u54e9\u5f39\u5e55\u7f51\u7684\u8bc4\u8bba\u7cfb\u7edf\uff0c\u539f\u5730\u5740\u4e3a:",l.default.createElement("a",{target:"_blank",href:"https://h.bilibili.com/16116344#canvas-detail-comment-ctnr"},"h16116344"),"\uff0c\u5982\u679c\u65e0\u6cd5\u94fe\u63a5\u52a9\u624b\uff0c\u53ef\u4ee5\u524d\u5f80\u8be5\u9875\u9762\u8fdb\u884c\u7559\u8a00",l.default.createElement("br",null),"\u8bf7\u9075\u5b88\u76f8\u5173\u6cd5\u5f8b\u6cd5\u89c4\u5e76\u5171\u540c\u7ef4\u62a4\u79e9\u5e8f")),l.default.createElement(A.default,{global:!0,receiver:{mid:n,uname:s}}),o.status.connected&&l.default.createElement(l.default.Fragment,null,0===Q&&!v&&!h&&!B&&!p.comment.loadPage&&l.default.createElement("div",{className:"no-reply"},"\u6ca1\u6709\u7559\u8a00\uff0c",!a.info&&"\u767b\u9646\u540e","\u5f00\u59cb\u8bc4\u8bba\u5427~"),0!==Q&&(v||h||B||p.comment.loadPage)&&l.default.createElement("div",{className:"more-comment-list-wrapper",ref:e=>this.moreCommentListWrapper=e},1===D&&v&&l.default.createElement("div",{className:"wrapper"},l.default.createElement("div",{id:"top",className:"comment-list"},this.renderLine((0,r.default)({},v,{top:!0}))),l.default.createElement(w,{disabled:!0},"IT'S A TOP COMMENT ABOVE")),1===D&&h&&l.default.createElement("div",{className:"list-wrapper"},l.default.createElement("div",{id:"hots",className:"comment-list"},h.map(e=>v?e.rpid!==v.rpid&&this.renderLine(e):this.renderLine(e))),l.default.createElement(w,{onClick:this.handleOnClickHots},"LOAD MORE HOT COMMENTS")),B&&l.default.createElement("div",{className:"list-wrapper"},l.default.createElement("div",{id:"comments",className:"comment-list"},B.map(e=>v?e.rpid!==v.rpid&&this.renderLine(e):this.renderLine(e))),this.renderPageNavigation({oid:c.oid,pageIndex:j,num:D,pages:y})),p.comment.loadPage&&l.default.createElement("div",{className:"loading-page-mask"},l.default.createElement(u.default,{url:m.LOADING_IMAGE_URL,sign:"loading-gif"}))))))}),this.state={uname:"",rpid:null}}componentDidMount(){this.load()}componentDidUpdate(e){this.props.location.query.page!==e.location.query.page&&"0"===e.location.query.ptype&&this.load()}}var k=(0,s.default)((0,p.connect)(e=>{var t=e.global,a=e.comments,o=e.user;return{global:t,comments:a,user:o}})(B));t.default=k},HjWF:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("cDcd")),i=o(a("vOnD")),l=i.default.div`
  width: 800px;
  height: 20px;
  margin: 20px auto;
  & > * {
...
`;class n extends r.default.Component{constructor(e){super(e)}render(){return r.default.createElement(l,null,r.default.createElement("a",{href:"https://github.com/bilibili-helper/bilibili-helper/blob/master/LICENSE",target:"_blank"},r.default.createElement("img",{src:"https://img.shields.io/github/license/mashape/apistatus.svg?style=social",alt:"LICENSE"})),r.default.createElement("a",{href:"https://chrome.google.com/webstore/detail/kpbnombpnpcffllnianjibmpadjolanh",target:"_blank"},r.default.createElement("img",{src:"https://img.shields.io/chrome-web-store/v/kpbnombpnpcffllnianjibmpadjolanh.svg?style=social",alt:"Chrome Web Store"})),r.default.createElement("a",{href:"https://chrome.google.com/webstore/detail/kpbnombpnpcffllnianjibmpadjolanh",target:"_blank"},r.default.createElement("img",{src:"https://img.shields.io/chrome-web-store/d/kpbnombpnpcffllnianjibmpadjolanh.svg?style=social",alt:"Users"})),r.default.createElement("iframe",{src:"https://ghbtns.com/github-btn.html?user=bilibili-helper&repo=bilibili-helper&type=star&count=true",frameBorder:"0",scrolling:"0",width:"170px",height:"20px"}))}}t.default=n},Kvkj:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"CommentArea",{enumerable:!0,get:function(){return r.default}}),Object.defineProperty(t,"HeaderArea",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"DownloadArea",{enumerable:!0,get:function(){return l.default}}),Object.defineProperty(t,"WebsiteUpdateArea",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"AnnouncementArea",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"BadgeArea",{enumerable:!0,get:function(){return d.default}}),Object.defineProperty(t,"FeedbackArea",{enumerable:!0,get:function(){return c.default}}),Object.defineProperty(t,"VoteArea",{enumerable:!0,get:function(){return p.default}}),Object.defineProperty(t,"Page",{enumerable:!0,get:function(){return u.default}}),Object.defineProperty(t,"FeedArea",{enumerable:!0,get:function(){return g.default}}),Object.defineProperty(t,"Header",{enumerable:!0,get:function(){return A.Header}});var r=o(a("8wrG")),i=o(a("jbW3")),l=o(a("1ZZj")),n=o(a("0q1Z")),s=o(a("ZyJ2")),d=o(a("HjWF")),c=o(a("XeeE")),p=o(a("5BdJ")),u=o(a("RXmK")),g=o(a("oD3C")),A=a("rY4l")},Pa8V:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("quD3")),i=o(a("cDcd")),l=o(a("vOnD")),n=a("MuoO"),s=o(a("5Epl")),d=l.default.div.attrs({className:"comment-editor"})`
  position: relative;
  display: flex;
  margin-bottom: 40px;
  padding-bottom: 30px;
...
`;class d extends i.default.Component{constructor(e){super(e)}render(){var e=this.props.announcements;return i.default.createElement(s,{id:"announcement"},i.default.createElement("h3",null,"\u91cd\u8981\u516c\u544a ~ ANNOUNCEMENTS"),r.default.map(e.config,(e,t)=>"\u529f\u80fd\u5220\u9664\u987b\u77e5"===t&&i.default.createElement("div",{className:"item",key:t},i.default.createElement("ul",{className:"content"},e.map((e,t)=>i.default.createElement("li",{key:t,dangerouslySetInnerHTML:{__html:e}}))))))}}var c=(0,l.connect)(e=>{var t=e.announcements;return{announcements:t}})(d);t.default=c},jbW3:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("cDcd")),i=a("MuoO"),l=o(a("vOnD")),n=l.default.div.attrs({className:"header-box"})`
  position: relative;
  flex-shrink: 0;
  margin-bottom: 40px;
  padding-bottom: 0;
...
`;class d extends r.default.Component{constructor(e){super(e),this.handleOnClickLogin=((e,t)=>{e||t?location.href=location.href:this.props.dispatch({type:"global/connectHelper"})})}render(){var e=this.props.global,t=e.status,a=t.connected,o=t.tryConnect,i=t.initializing;return r.default.createElement(r.default.Fragment,null,r.default.createElement(n,null,r.default.createElement("div",{className:"header-box"},r.default.createElement("div",{className:"title-box"},r.default.createElement("h1",null,"BILIBILI HELPER"),r.default.createElement("div",{className:"version-box"},e.config&&r.default.createElement("span",null,"Latest: ",e.config.lastVersion),e.version&&r.default.createElement("span",null,"Yours: ",e.version))),r.default.createElement("div",{className:"action-box"},!a&&o?r.default.createElement("div",{className:"login-box"},r.default.createElement(s,{className:"login-btn",onClick:()=>this.handleOnClickLogin(a,o)},i&&"\u8fde\u63a5\u4e2d",!i&&!a&&!o&&"\u8fde\u63a5\u52a9\u624b",!i&&!a&&o&&"\u8fde\u63a5\u52a9\u624b\u5931\u8d25\uff0c\u70b9\u51fb\u5237\u65b0\u91cd\u8bd5"),!a&&o&&r.default.createElement("span",null,"\u5982\u679c\u60a8\u7684\u6d4f\u89c8\u5668\u672a\u5b89\u88c5\u52a9\u624b\u6216\u52a9\u624b\u7248\u672c\u5c0f\u4e8e 1.2.0.8\uff0c\u8fde\u63a5\u5c06\u4f1a\u5931\u8d25",r.default.createElement("br",null),"\u8bf7\u5b89\u88c5\u52a9\u624b\u6216\u8005\u66f4\u65b0\u81f3\u65b0\u7248\u672c")):null))))}}var c=(0,i.connect)(e=>{var t=e.global,a=e.user;return{global:t,user:a}})(d);t.default=c},oD3C:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("etV5")),i=o(a("5Epl")),l=o(a("cDcd")),n=a("MuoO"),s=o(a("vOnD")),d=a("rY4l"),c=o(a("RXmK")),p=a("c7k8"),u=(0,s.default)(c.default)`
  position: relative;
  img {
    position: absolute;
    top: 82px;
...
`;class m extends l.default.Component{constructor(e){super(e),this.renderLine=(e=>{var t=e.index,a=e.style,o=this.props.global,i=(0,r.default)(o.feeds[t],4),n=i[0],s=i[1],d=i[2],c=i[3],p=d>=10,u=d>=5&&d<10;return l.default.createElement(A,{style:a,key:t,className:`${u?"largeThanFive":p?"largeThanTen":""}`},l.default.createElement("span",{className:"date"},n),l.default.createElement("span",{className:"name"},s),l.default.createElement("span",{className:"num"},"\uffe5 ",Number(d).toFixed(2)),l.default.createElement("span",{className:"message"},c))})}render(){var e=this.props.global;return l.default.createElement(u,null,l.default.createElement(d.Header,null,"\u6295\u5582\u533a\u9e2d ~ FEEDS",l.default.createElement("p",null,"\u611f\u8c22\u5927\u5bb6\u7684\u652f\u6301\u9e2d~mua~")),l.default.createElement(g,{width:800,height:200,rowCount:e.feeds&&e.feeds.length||0,rowHeight:28,rowRenderer:this.renderLine,noRowsRenderer:()=>l.default.createElement("div",null,"\u65e0\u6570\u636e")}),l.default.createElement(i.default,{src:"../static/images/alipay-df.png"}))}}var b=(0,n.connect)(e=>{var t=e.global;return{global:t}})(m);t.default=b},rB1f:function(e,t,a){"use strict";var o=a("g2Oz"),r=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var i=r(a("cDcd")),l=a("MuoO"),n=o(a("vOnD")),s=r(a("Bo8p")),d=a("Kvkj"),c=n.createGlobalStyle`
  html {
...
`,p=()=>i.default.createElement(i.default.Fragment,null,i.default.createElement(c,null),i.default.createElement(d.HeaderArea,null),i.default.createElement(d.DownloadArea,null),i.default.createElement(d.WebsiteUpdateArea,null),i.default.createElement(d.VoteArea,null),i.default.createElement(d.AnnouncementArea,null),i.default.createElement(d.FeedbackArea,null),i.default.createElement(d.FeedArea,null),i.default.createElement(d.BadgeArea,null),i.default.createElement(d.CommentArea,null)),u=(0,s.default)((0,l.connect)(e=>e)(p));t.default=u},rY4l:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.Header=void 0;var r=o(a("cDcd")),i=o(a("vOnD")),l=i.default.h3`
  align-items: center;
  margin: 15px 0 20px;
  font-size: 16px;
  color: #212121;
