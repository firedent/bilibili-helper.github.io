...
`,f=l.default.button`
  ...
  outline: none;
  user-select: none;
`;class x extends i.default.Component{constructor(e){super(e),this.handleOnClickPinball=(()=>{var e=this;return Promise.resolve().then(a.t.bind(null,"YAsm",7)).then(t=>{var a=t.createApp;this.app||(this.app=a(c,d)),this.view.appendChild(this.app.view),this.app.view.addEventListener("click",function(t){t.preventDefault(),e.handlePause(t)}),this.app.stop(),document.body.style.overflow="hidden",this.setState({show:!this.state.show})})}),this.handleOnClickCloseBtn=(e=>{e.preventDefault(),this.setState({show:!1}),this.handlePause(e),document.body.style.overflow=""}),this.handleOnScroll=(e=>{return e.preventDefault(),!1}),this.handleStart=(e=>{e.preventDefault(),this.setState({play:!0,pause:!1}),this.app.start()}),this.handlePause=(e=>{e.preventDefault(),this.setState({play:!1,pause:!0}),this.app.stop()}),this.app=null,this.state={show:!1,play:!1,pause:!1}}componentDidMount(){this.handleOnClickPinball().then(()=>{this.setState({play:!0,pause:!1}),this.app.start()})}render(){var e=this.state,t=e.play,a=e.pause;return i.default.createElement(i.default.Fragment,null,i.default.createElement(u,{className:"pinball",onClick:this.handleOnClickPinball}),i.default.createElement(g,{ref:e=>this.view=e,show:this.state.show,onScroll:this.handleOnScroll},i.default.createElement(b,null,"RPG Pinball"),i.default.createElement(h,null,"\u4e00\u6b3e\u53ef\u4ee5\u6253\u602a\u5347\u7ea7\u7684RPG\u6253\u7816\u5757\u6e38\u620f~ \u5f00\u53d1\u4e2d~"),i.default.createElement(A,{onClick:this.handleOnClickCloseBtn},"Close"),!t&&!a&&i.default.createElement(f,{onClick:this.handleStart},"Start"),!t&&a&&i.default.createElement(f,{onClick:this.handleStart},"Play"),!t&&i.default.createElement(m,null)))}}t.PinballArea=x},Pa8V:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("quD3")),i=o(a("cDcd")),l=o(a("vOnD")),n=a("MuoO"),s=o(a("5Epl")),c=l.default.div.attrs({className:"comment-editor"})`
  position: relative;
  display: flex;
  margin-bottom: 40px;
  padding-bottom: 30px;
