...
`;class g extends s.default.Component{constructor(e){super(e);var t=e.sign,a=e.url;this.props.dispatch({type:"image/fetch",payload:{url:a,sign:t}})}render(){var e=this.props,t=e.image,a=e.sign,o=(e.url,e.dispatch,e.className),r=(0,l.default)(e,["image","sign","url","dispatch","className"]);return s.default.createElement(d.default,{once:!0},s.default.createElement(u,(0,i.default)({className:["model-img",o].join(" "),key:a,src:t[a]||null},r)))}}var m=(0,n.connect)(e=>{var t=e.image;return{image:t}})(g);t.default=m},"8wrG":function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("quD3")),i=o(a("YLtl")),l=o(a("cDcd")),n=o(a("vOnD")),s=o(a("Bo8p")),c=o(a("R18Y")),d=o(a("wd/R")),p=a("MuoO"),u=o(a("5Epl")),g=o(a("+4mJ")),m=o(a("Pa8V")),A=a("ywEC"),b=o(a("RXmK")),h=a("f23f");d.default.locale("zh-cn");var f=(0,n.default)(b.default).attrs({className:"comment-area"})`
  position: relative;
  .no-reply {
    color: var(--content-color);
  }
