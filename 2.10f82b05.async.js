...
`,p=c.default.img`
  ...
  &[src] {
    animation: ${d} cubic-bezier(0.16, 0.6, 0.45, 0.93);
    animation-duration: 1s;
  }
`;class u extends s.default.Component{constructor(e){super(e);var t=e.sign,a=e.url;a&&this.props.dispatch({type:"image/fetch",payload:{url:a,sign:t}})}render(){var e=this.props,t=e.image,a=e.sign,o=(e.url,e.dispatch,e.className),r=(0,l.default)(e,["image","sign","url","dispatch","className"]);return s.default.createElement(p,(0,i.default)({className:["model-img",o].join(" "),key:a,src:t[a]||null},r))}}var g=(0,n.connect)(e=>{var t=e.image;return{image:t}})(u);t.default=g},"8wrG":function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("quD3")),i=o(a("YLtl")),l=o(a("cDcd")),n=o(a("vOnD")),s=o(a("Bo8p")),c=o(a("R18Y")),d=o(a("wd/R")),p=a("MuoO"),u=o(a("5Epl")),g=o(a("+4mJ")),m=o(a("Pa8V")),A=a("ywEC"),b=o(a("RXmK")),h=a("f23f"),f=o(a("JeI0"));d.default.locale("zh-cn");var x=(0,n.default)(b.default).attrs({className:"comment-area"})`
  position: relative;
  .no-reply {
    color: var(--content-color);
  }
...
`,v=n.default.header.attrs({className:"comment-list-header"})`
  font-size: 20px;
...
`,w=n.default.div.attrs({className:"comment-item"})`
  display: flex;
  margin-bottom: 30px;
  &:last-of-type > .main{
...
`,k=n.default.div.attrs({className:"page-navigation"})`
  display: flex;
...
`;class Q extends l.default.Component{constructor(e){var t;super(e),t=this,this.load=(e=>{var t=this.props,a=t.comments,o=t.dispatch,r=t.location,i=e.config;!i&&a.config&&(e=a.config,i=e.config);var l=r.query,n=l.oid,s=void 0===n?i.oid:n,c=l.page,d=void 0===c?1:c,p=l.ptype,u=void 0===p?0:p,g=l.type,m=void 0===g?i.type:g,A={oid:s,[+u?"ps":"pn"]:d,type:m};o({type:"comments/load",payload:{comment:e,query:A,ptype:+u}})}),this.calculateNavigationPageIndex=((e,t)=>{var a=new Array(t).fill(void 0).map((e,t)=>t),o=i.default.compact(a.map((t,a)=>{if(Math.abs(e-a-1)<=2)return a+1<=0?void 0:a+1}));return 1!==o[0]&&(o[0]>2&&o.unshift("-"),o.unshift(1)),o.length>1&&o[o.length-1]<t&&(t-o[o.length-1]>1&&o.push("-"),o.push(t)),o}),this.handleOnClickHots=(()=>{this.props.dispatch({type:"comments/fetchComment",payload:{sort:1}})}),this.handleOnClickLoadMoreReplies=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};t.props.dispatch({type:"comments/fetchReply",payload:(0,r.default)({pn:1,ps:10},e)})},this.handleOnClickNavigation=(()=>{window.scrollTo(0,(0,h.cumulativeOffset)(this.moreCommentListWrapper).top-20)}),this.handleOnClickNavigationForReply=(e=>{var t=this[`reply-${e.root}`];t&&t.querySelector(".replies-box").scrollIntoView({behavior:"smooth",inline:"start"}),this.props.dispatch({type:"comments/fetchReply",payload:e})}),this.handleOnClickReply=(e=>{var t=e.uname,a=e.rpid;return this.setState({uname:t,rpid:a===this.state.rpid?null:a})}),this.handleOnClickLike=((e,t)=>{this.props.dispatch({type:"comments/setLike",payload:{action:e,rpid:t}})}),this.handleOnClickHate=((e,t)=>{this.props.dispatch({type:"comments/setHate",payload:{action:e,rpid:t}})}),this.renderContent=(e=>{e=e.replace("\u3010","[").replace("\u3011","]");var t=new RegExp(/(\[.*?\])/g),a=[],o=null,r=0;while(null!==(o=t.exec(e))){var i=o,n=i.index,s=o[0];a.push(e.substr(r,n-r)),r=n+s.length,a.push(l.default.createElement(g.default,{key:n,sign:s}))}return e.substr(r)&&a.push(e.substr(r)),0===a.length&&a.push(e),a}),this.renderLine=(e=>{var t=e.rpid,a=e.top,o=this.props.comments,r=o.config,i=o.status,n=this.props.comments.replyMap[t],s=n.self,c=s.action,p=s.content,g=s.member,b=s.floor,h=s.ctime,x=s.like,v=s.oid,k=s.root,B=this.state,C=B.uname,Q=B.rpid,y=g.avatar,D=g.mid,I=g.uname,j=g.level_info,M=g.vip,N=j.current_level,O=M.vipType,G=Q===t,R=[],F=!1;return n.replies&&(F=n.needExpand&&!n.hasExpand,R=this.calculateNavigationPageIndex(n.page.num,n.pages)),l.default.createElement(w,{key:t,id:t,ref:e=>this[`reply-${t}`]=e},l.default.createElement("div",{className:"user"},l.default.createElement(f.default,null,l.default.createElement(u.default,{className:"avatar",url:y,sign:D}))),l.default.createElement("div",{className:"main"},l.default.createElement("div",{className:"header"},a&&l.default.createElement("span",{className:"top"},"TOP"),l.default.createElement("a",{className:`username ${O?"vip":""}`,href:`https://space.bilibili.com/${D}`,target:"_blank"},I),N&&l.default.createElement("span",{className:"level"},"Lv.",N),l.default.createElement("span",{className:"moment"},(0,d.default)(1e3*h).startOf("second").fromNow()),b&&l.default.createElement("span",{className:"floor"},"#",b)),l.default.createElement("div",{className:"content"},l.default.createElement("pre",null,this.renderContent(p.message)),l.default.createElement("div",{className:"toolbar"},l.default.createElement("div",{className:"like-box"},l.default.createElement("span",{className:"like",on:1===c?"1":"0",onClick:()=>this.handleOnClickLike(Number(1!==c),t)},"LIKE ",x||""),l.default.createElement("span",{className:"hate",on:2===c?"1":"0",onClick:()=>this.handleOnClickHate(Number(2!==c),t)},"HATE")),r.canComment&&l.default.createElement("button",{className:"reply",on:G?"1":"0",onClick:()=>this.handleOnClickReply({uname:I,rpid:t})},"REPLY"))),G&&l.default.createElement(m.default,{root:k||t,parent:t,name:C}),n.replies&&n.replies.length>0&&l.default.createElement("div",{className:"replies-box"},l.default.createElement("div",{className:"replies"},n.replies.map(e=>this.renderLine(e))),F&&1===n.page.num&&l.default.createElement(E,{onClick:()=>this.handleOnClickLoadMoreReplies({root:t,oid:v})},"~ LOAD MORE ~"),!F&&n.pages>1&&this.renderPageNavigation({oid:r.config.oid,pageIndex:R,num:n.page.num,pages:n.pages,root:t,ptype:1}),i.comment.loadingRpid===t&&l.default.createElement("div",{className:"loading-page-mask"},l.default.createElement(u.default,{url:A.LOADING_IMAGE_URL,sign:"loading-gif"})))))}),this.renderPageNavigation=(e=>{var t=e.oid,a=e.pageIndex,o=e.num,r=e.pages,i=e.root,n=e.ptype,s=void 0===n?0:n,d=()=>{};return d=i?e=>this.handleOnClickNavigationForReply({pn:e,ps:10,sort:0,root:i}):e=>this.handleOnClickNavigation({pn:e}),l.default.createElement(k,null,a.length>2&&o>1&&l.default.createElement(c.default,{key:"prev",to:`?oid=${t}&page=${o-1}&ptype=${s}`},l.default.createElement("span",{className:"page-navigation-link",onClick:()=>d(o-1)},"PREV")),a.map((e,a)=>{return l.default.createElement(c.default,{key:e+a,to:`?oid=${t}&page=${e}&ptype=${s}`},l.default.createElement("span",{className:`page-navigation-link ${"-"===e?"omit":""} ${o===e?"now":""}`,onClick:o!==e&&"-"!==e?()=>d(e):null},"-"!==e?e:"..."))}),a.length>2&&o<r&&l.default.createElement(c.default,{key:"next",to:`?oid=${t}&page=${o+1}&ptype=${s}`},l.default.createElement("span",{className:"page-navigation-link",onClick:()=>d(o+1)},"NEXT")))}),this.render=(()=>{var e=this.props,t=e.comments,a=e.user,o=e.global,i=this.state,n=i.mid,s=i.uname,d=t.data,p=t.config,g=t.status,b=t.commentMap,h=d.page,f=d.hots,w=d.top,k=d.replies,Q=void 0===k?[]:k,y=h.count,D=h.size,I=h.acount,j=h.num,M=Math.ceil(y/D)||1,N=this.calculateNavigationPageIndex(j,M);return l.default.createElement(x,null,l.default.createElement(v,null,`${I} \u8bc4\u8bba`,null===p&&l.default.createElement("p",null,"\u5c1a\u672a\u52a0\u8f7d\u8bc4\u8bba\u533a"),p&&l.default.createElement("p",null,"\u672c\u8bc4\u8bba\u533a\u6765\u81ea\u54d4\u54e9\u54d4\u54e9\u5f39\u5e55\u7f51\u7684\u8bc4\u8bba\u7cfb\u7edf\uff0c\u8bf7\u9075\u5b88\u76f8\u5173\u6cd5\u5f8b\u6cd5\u89c4\u5e76\u5171\u540c\u7ef4\u62a4\u79e9\u5e8f",p.canComment&&l.default.createElement(l.default.Fragment,null,"\uff0c\u539f\u5730\u5740\u4e3a:",l.default.createElement("a",{target:"_blank",href:`https://h.bilibili.com/${p.config.oid}#canvas-detail-comment-ctnr`},"h",p.config.oid)))),p&&l.default.createElement(m.default,{global:!0,receiver:{mid:n,uname:s},able:p.canComment}),o.status.connected&&p&&l.default.createElement(l.default.Fragment,null,0===I&&!w&&!f&&!Q&&!g.comment.loadPage&&l.default.createElement("div",{className:"no-reply"},"\u6ca1\u6709\u7559\u8a00\uff0c",!a.info&&"\u767b\u9646\u540e","\u5f00\u59cb\u8bc4\u8bba\u5427~"),0!==I&&(w||f||Q||g.comment.loadPage)&&l.default.createElement("div",{className:"more-comment-list-wrapper",ref:e=>this.moreCommentListWrapper=e},1===j&&w&&l.default.createElement("div",{className:"wrapper"},l.default.createElement("div",{id:"top",className:"comment-list"},this.renderLine((0,r.default)({},w,{top:!0}))),l.default.createElement(E,{disabled:!0},"IT'S A TOP COMMENT ABOVE")),1===j&&f&&l.default.createElement("div",{className:"list-wrapper"},l.default.createElement("div",{id:"hots",className:"comment-list"},f.map(e=>w?e.rpid!==w.rpid&&this.renderLine(e):this.renderLine(e))),l.default.createElement(E,{onClick:this.handleOnClickHots},"LOAD MORE HOT COMMENTS")),Q&&l.default.createElement("div",{className:"list-wrapper"},l.default.createElement("div",{id:"comments",className:"comment-list"},Q.map(e=>w?e.rpid!==w.rpid&&this.renderLine(e):this.renderLine(e))),this.renderPageNavigation({oid:p.config.oid,pageIndex:N,num:j,pages:M})),g.comment.loadPage&&l.default.createElement("div",{className:"loading-page-mask"},l.default.createElement(u.default,{url:A.LOADING_IMAGE_URL,sign:"loading-gif"})))),b&&p&&l.default.createElement(B,null,l.default.createElement(C,null,b.map(e=>{var t=e.config,a=e.name,o=t.oid,r=+o===+p.config.oid;return l.default.createElement(c.default,{key:o,to:`?oid=${o}&page=1&ptype=0`,className:`nav-item ${r?"on":""}`},a)}),l.default.createElement("i",null,"\u5207\u6362\u8bc4\u8bba\u533a"))))}),this.state={uname:"",rpid:null}}componentDidUpdate(e){var t=this.props,a=t.comments,o=t.location,r=a.commentMap;if(o.query.page!==e.location.query.page&&"0"===e.location.query.ptype||o.query.oid!==e.location.query.oid||void 0!==e.location.query.oid&&!e.comments.config){var l=i.default.find(r,e=>e.config.oid===+o.query.oid);this.load(l)}else!e.comments.config&&r.length>=e.comments.commentMap.length&&!o.query.oid&&r.length>0&&this.load(r[0])}}var y=(0,s.default)((0,p.connect)(e=>{var t=e.global,a=e.comments,o=e.user;return{global:t,comments:a,user:o}})(Q));t.default=y},HjWF:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("cDcd")),i=o(a("vOnD")),l=i.default.div`
  width: 800px;
  height: 20px;
  margin: 20px auto;
  & > * {
...
`;class n extends r.default.Component{constructor(e){super(e)}render(){return r.default.createElement(l,null,r.default.createElement("a",{href:"https://github.com/bilibili-helper/bilibili-helper/blob/master/LICENSE",target:"_blank"},r.default.createElement("img",{src:"https://img.shields.io/github/license/mashape/apistatus.svg?style=social",alt:"LICENSE"})),r.default.createElement("a",{href:"https://chrome.google.com/webstore/detail/kpbnombpnpcffllnianjibmpadjolanh",target:"_blank"},r.default.createElement("img",{src:"https://img.shields.io/chrome-web-store/v/kpbnombpnpcffllnianjibmpadjolanh.svg?style=social",alt:"Chrome Web Store"})),r.default.createElement("a",{href:"https://chrome.google.com/webstore/detail/kpbnombpnpcffllnianjibmpadjolanh",target:"_blank"},r.default.createElement("img",{src:"https://img.shields.io/chrome-web-store/d/kpbnombpnpcffllnianjibmpadjolanh.svg?style=social",alt:"Users"})),r.default.createElement("iframe",{src:"https://ghbtns.com/github-btn.html?user=bilibili-helper&repo=bilibili-helper&type=star&count=true",frameBorder:"0",scrolling:"0",width:"170px",height:"20px"}))}}t.default=n},Kvkj:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"CommentArea",{enumerable:!0,get:function(){return r.default}}),Object.defineProperty(t,"HeaderArea",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"DownloadArea",{enumerable:!0,get:function(){return l.default}}),Object.defineProperty(t,"WebsiteUpdateArea",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"AnnouncementArea",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"BadgeArea",{enumerable:!0,get:function(){return c.default}}),Object.defineProperty(t,"FeedbackArea",{enumerable:!0,get:function(){return d.default}}),Object.defineProperty(t,"VoteArea",{enumerable:!0,get:function(){return p.default}}),Object.defineProperty(t,"Page",{enumerable:!0,get:function(){return u.default}}),Object.defineProperty(t,"FeedArea",{enumerable:!0,get:function(){return g.default}}),Object.defineProperty(t,"Header",{enumerable:!0,get:function(){return m.Header}});var r=o(a("8wrG")),i=o(a("jbW3")),l=o(a("1ZZj")),n=o(a("0q1Z")),s=o(a("ZyJ2")),c=o(a("HjWF")),d=o(a("XeeE")),p=o(a("5BdJ")),u=o(a("RXmK")),g=o(a("oD3C")),m=a("rY4l")},Pa8V:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("quD3")),i=o(a("cDcd")),l=o(a("vOnD")),n=a("MuoO"),s=o(a("5Epl")),c=l.default.div.attrs({className:"comment-editor"})`
  position: relative;
  display: flex;
  margin-bottom: 40px;
  padding-bottom: 30px;
...
`;class c extends r.default.Component{constructor(e){super(e),this.handleOnClickLogin=((e,t)=>{e||t?location.href=location.href:this.props.dispatch({type:"global/connectHelper"})}),this.app=null,this.state={showPinball:!1}}render(){var e=this.props.global,t=e.status,a=t.connected,o=t.tryConnect,i=t.initializing;return r.default.createElement(r.default.Fragment,null,r.default.createElement(n,null,r.default.createElement("div",{className:"header-box"},r.default.createElement("div",{className:"title-box"},r.default.createElement("h1",null,"BILIBILI HELPER"),r.default.createElement("div",{className:"version-box"},e.config&&r.default.createElement("span",null,"Latest: ",e.config.lastVersion),e.version&&r.default.createElement("span",null,"Yours: ",e.version))),r.default.createElement("div",{className:"action-box"},!a&&o?r.default.createElement("div",{className:"login-box"},r.default.createElement(s,{className:"login-btn",onClick:()=>this.handleOnClickLogin(a,o)},i&&"\u8fde\u63a5\u4e2d",!i&&!a&&!o&&"\u8fde\u63a5\u52a9\u624b",!i&&!a&&o&&"\u8fde\u63a5\u52a9\u624b\u5931\u8d25\uff0c\u70b9\u51fb\u5237\u65b0\u91cd\u8bd5"),!a&&o&&r.default.createElement("span",null,"\u5982\u679c\u60a8\u7684\u6d4f\u89c8\u5668\u672a\u5b89\u88c5\u52a9\u624b\u6216\u52a9\u624b\u7248\u672c\u5c0f\u4e8e 1.2.0.8\uff0c\u8fde\u63a5\u5c06\u4f1a\u5931\u8d25",r.default.createElement("br",null),"\u8bf7\u5b89\u88c5\u52a9\u624b\u6216\u8005\u66f4\u65b0\u81f3\u65b0\u7248\u672c")):null))))}}var d=(0,i.connect)(e=>{var t=e.global,a=e.user;return{global:t,user:a}})(c);t.default=d},oD3C:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r=o(a("etV5")),i=o(a("cDcd")),l=a("MuoO"),n=o(a("vOnD")),s=a("rY4l"),c=o(a("5Epl")),d=o(a("RXmK")),p=a("c7k8"),u=(0,n.default)(d.default)`
  position: relative;
  img {
    position: absolute;
    top: 82px;
...
`,p=()=>i.default.createElement(i.default.Fragment,null,i.default.createElement(d,null),i.default.createElement(c.HeaderArea,null),i.default.createElement(c.DownloadArea,null),i.default.createElement(c.AnnouncementArea,null),i.default.createElement(c.WebsiteUpdateArea,null),i.default.createElement(c.VoteArea,null),i.default.createElement(c.FeedbackArea,null),i.default.createElement(c.FeedArea,null),i.default.createElement(c.BadgeArea,null),i.default.createElement(c.CommentArea,null)),u=(0,s.default)((0,l.connect)(e=>e)(p));t.default=u},rY4l:function(e,t,a){"use strict";var o=a("svvH");Object.defineProperty(t,"__esModule",{value:!0}),t.Header=void 0;var r=o(a("cDcd")),i=o(a("vOnD")),l=i.default.h3`
  align-items: center;
  margin: 15px 0 20px;
  font-size: 16px;
  color: #212121;
