import {BOTTOM, CENTER, EPSILON, LEFT, LimitedVector2, NOT_INTERSECT, RIGHT, TOP, Vector2} from 'Pinball/game/lib';
...
import {Collision} from 'Pinball/game/lib/Collision';
