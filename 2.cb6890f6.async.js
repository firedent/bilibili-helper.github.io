...
`,f=n.default.header.attrs({className:"comment-list-header"})`
  font-size: 20px;
...
`,x=n.default.div.attrs({className:"comment-item"})`
  display: flex;
  margin-bottom: 30px;
  &:last-of-type > .main{
...
`,w=n.default.div.attrs({className:"page-navigation"})`
  display: flex;
